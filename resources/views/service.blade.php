        ...
        <div class="service-caution">
            <div class="service-caution__container">
                <div animate class="service-caution__content">
                    В данном разделе представлены только основные запчасти и расходные материалы, для
                    ознакомления с полным перечнем <a href="#" data-popup="#popup">обращайтесь к менеджерам</a>
                </div>
            </div>
        </div>
